...
// What would constitute a character profile?
const profile = [
	{
		id: ids[5],
		name: "Azura le Fonnta",
		type: "person",
		traits: [
			"quiet",
			"stoic",
		...
		relationships: [
			{
				id: "",
				name: "Lapiza le Fonnta",
				relationship: "mother",
				description: `Of her siblings, she's the most similar to their father by nature, which caused her mother to fixate on her, demanding her attention and affection. She, however, has little regard for the woman, preferring the company of her younger friend, Tari, stoking her mother's ire and resentment.`
			}
		],
		affiliations: [],
		activity: [
