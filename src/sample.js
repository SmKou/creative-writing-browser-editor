const unprocessed = {
	no_sections: `# Lover in the Flesh
		...
		outline: {
			segments: {
				"azby-otl": {
					...
					type: "chapter",
					tag: "prologue",
					description: "Shaygra finds herself in a place of darkness and rot.",
					connect_to: {
						"azby": {
							path: { "draft-athrux": "draft" }
						}
					}
				},
				"mxnw-otl": {
					title: "Spaid Ardari advancing",
					type: "chapter",
					description: "Spaid Ardari advances on Shaygra. Her words (inadvertently) turn Shaygra's fear to anger.",
					connect_to: {
						"mxnw": {
							path: { "draft-athrux": "draft" },
							sync: true
				...
				"etoh-otl": {
					title: "",
					type: "section",
					description: "Shaygra struggles to breathe but feels something wrong about Spaid Ardari's voice.",
					connect_to: { "etoh": { "draft-athrux": "draft" }}
				},
				"itol-otl": {
					title: "",
					type: "section",
					description: "Spaid Ardari coaxes Shaygra into the light.",
					connect_to: { "itol": { "draft-athrux": "draft" }}
				},
				"mtop-otl": {
					title: "",
					type: "section",
					description: "Shaygra recognizes Spaid Ardari as a hunter and becomes angry at the coaxing and lie.",
					connect_to: { "mtop": { "draft-athrux": "draft" }}
				},
				"qtrs-otl": {
					title: "Spaid Ardari closes in",
					type: "chapter",
					description: "",
					connect_to: {
						"qtrs": {
				...
				"qtot-otl": {
					title: "",
					type: "scene",
					description: "Suddenly silence, Shaygra panics.",
					connect_to: { "qtot": { "draft-athrux": "draft" }}
				},
				"utox-otl": {
					title: "caught",
					type: "section",
					description: "Spaid Ardari taunts Shaygra from up close, still out of sight.",
					connect_to: { "utox": { "draft-athrux": "draft" }}
				},
				"yyzz-otl": {
					title: "awaken",
					type: "scene",
					description: "A dream she's had many times, Shaygra wakes up alone and helpless.",
					connect_to: "todo"
				}
			},
			order: [
				"azby-otl",
				{ "mxnw-otl": ["etoh-otl", "itol-otl", "mtop-otl"] },
				{ "qtrs-otl": ["qtot-otl", "utox-otl"] }
			]
		}
	}
}
...
const drafts = {
	"draft-athrux": {
		order: ["azby", "mxnw", "qtrs"],
		chapters: {
			"azby": {
				title: "",
				order: ["abcd", "abcc", "abbb", "aaaa"],
				connect_to: {
					"azby-otl": {
						path: "outline"
					}
		...
		sections: {
			"etoh": {
				title: "",
				order: ["efgh", "efgg", "efff"]
			},
			"itol": {
				title: "",
				order: ["ijkl", "ijkk", "ijjj", "iiii"]
			},
			"mtop": {
				title: "",
				order: ["mnop", "mnoo", "mnnn", "mmmm", "nnnn"]
			},
			"qtot": {
				title: "",
				order: ["qrst", "qrss", "qrrr", "qqqq"]
			},
			"utox": {
				title: "Scared Yet?",
				order: ["uvwx", "uvww", "uvvv", "uuuu", "vvvv", "wwww"]
			}
		},
		paragraphs: {
			"abcd": [
			...
			"efgh": ["efgh-1", "efgh-2"],
			"efgg": ["efgg-1", "efgg-2"],
			"efff": ["efff-1", "efff-2", "efff-3", "efff-4", "efff-5"],
			"ijkl": ["ijkl"],
			"ijkk": ["ijkk-1", "ijkk-2", "ijkk-3", "ijkk-4"],
			"ijjj": ["ijjj-1", "ijjj-2", "ijjj-3", "ijjj-4"],
			"iiii": ["iiii"],
			"mnop": ["mnop-1", "mnop-2", "mnop-3", "mnop-4"],
			"mnoo": ["mnoo"],
			"mnnn": ["mnnn-1", "mnnn-2", "mnnn-3", "mnnn-4"],
			"mmmm": ["mmmm"],
			"nnnn": ["nnnn"],
			"qrst": ["qrst-1", "qrst-2", "qrst-3", "qrst-4", "qrst-5", "qrst-6", "qrst-7", "qrst-8", "qrst-9", "qrst-10"],
			"qrss": ["qrss-1", "qrss-2", "qrss-3", "qrss-4", "qrss-5"],
			"qrrr": ["qrrr"],
			"qqqq": ["qqqq"],
			"uvwx": ["uvwx-1", "uvwx-2", "uvwx-3", "uvwx-4", "uvwx-5"],
			"uvww": ["uvww-1", "uvww-2", "uvww-3", "uvww-4", "uvww-5"],
			"uvvv": ["uvvv"],
			"uuuu": ["uuuu"],
			"vvvv": ["vvvv"],
			"wwww": ["wwww-1", "wwww-2"]
		...
		sentences: {
			"abcd-1": `At first, the woman’s voice was sweet and soothing, lulling her into a calming sea of colors and a blanket of warmth, but once she called her brother’s name, she felt doused with icy cold water.`,
			"abcd-2": `She opened her eyes and found herself in darkness, struck by the putrid, overwhelming smell of bodies rotting.`,
			"abcd-3": `So foul, like inhaling poison, she gasped for air, only to feel as if she’d tasted mold, a rotted carcass, and something else that stuck to the tongue.`,
			"abcd-4": `It was everywhere, but there was something she couldn’t place, something metallic and heavy.`,
			"abcd-5": `Her stomach lurched.`,
			"abcc": `Then it was that voice again, softly and lyrically, “Is someone there?”`,
			"abbb-1": `She held her breath and raised her hand to cover her mouth.`,
			"abbb-2": `Wanting to cry, she was crying, she could hardly breathe.`,
			"abbb-3": `She needed to breathe, but the smell, the taste, the poison.`,
			"aaaa": `“Hello?”`,
			"efgh-1": `She started to shake, her grip tightening over her mouth and gripping the hand she covered it with.`,
			"efgh-2": `Why couldn’t someone save her?`,
			"efgg-1": `Dizzy, she realized she’d missed some of the woman’s words, catching bits and pieces.`,
			"efgg-2": `“…step in the light, there’s fresh air there.”`,
			"efff-1": `She wouldn’t dare.`,
			"efff-2": `Unable to hold it, she moved her hand and sucked in air to the bottom of her lungs as if she were yawning, not letting her chest rise or fall.`,
			"efff-3": `She hoped they couldn’t hear her, they couldn’t find her, but as she refocused her gaze, she saw a figure creeping through the dark.`,
			"efff-4": `That voice was cajoling, comforting, trying to reassure her, except that there was something wrong.`,
			"efff-5": `They sounded too sweet, too knowing, and something in her hated it.`,
			"ijkl": `She focused on keeping her breath soundless, but they could probably see her anyway.`,
			"ijkk-1": `“I can’t see you,” the voice cooed, “do you see the light?”`,
			"ijkk-2": `It was too sweet, no nuance, no change.`,
			"ijkk-3": `A pressure was building in her chest.`,
			"ijkk-4": `“Be careful. Move slowly. Make your way to the light, then I can help you.”`,
			"ijjj-1": `Go away, she cried in her head, go away!`,
			"ijjj-2": `The stench of rot, of bodies rotting, suddenly it struck her.`,
			"ijjj-3": `It could only make sense.`,
			"ijjj-4": `The air was saturated with blood, and who else could be talking to her other than the killer?`,
			"iiii": `“I can’t see you.”`,
			"mnop-1": `Though she stood in the shadows, seeing the figure moving through the dark and the sound of that voice, she felt they could see her.`,
			"mnop-2": `She knew they could see her.`,
			"mnop-3": `They knew exactly where she was.`,
			"mnop-4": `Was it her heat, her smell, her breathing, her racing heart?`,
			"mnoo": `“Can you move towards the light, I need to see you.”`,
			"mnnn-1": `Creeping closer and closer, the voice didn’t even try to hide its distance.`,
			"mnnn-2": `They could already see her.`,
			"mnnn-3": `Liar.`,
			"mnnn-4": `Murderer.`,
			"mmmm": `“I can’t see you—”`,
			"nnnn": `"You can," she screamed, "I know you can. What creature of the dark can't see without light! You liar, you're a liar!"`,
			"qrst-1": `Her words bounced off the walls, traveling far and wide, answered with silence.`,
			"qrst-2": `Nothing spoke, nothing moved.`,
			"qrst-3": `Was it gone?`,
			"qrst-4": `Was it just a voice?`,
			"qrst-5": `Had she imagined the movement in the dark?`,
			"qrst-6": `Even a second without thought or fear, the stench overwhelmed her and she felt her stomach convulse with the urge to vomit.`,
			"qrst-7": `She heard her heart, felt it thumping fast in her chest.`,
			"qrst-8": `Her every breath was loud in her ears.`,
			"qrst-9": `It made no difference to make it soundless.`,
			"qrst-10": `They could see her.`,
			"qrss-1": `She didn't know where she was, but he stench made her see piles of half-eaten bodies in the dark.`,
			"qrss-2": `Maggots, torn skin, flesh, and bone, and all the blood.`,
			"qrss-3": `How many bodies—how many creatures?`,
			"qrss-4": `How much blood?`,
			"qrss-5": `Such a waste.`,
			"qrrr": `Where was it?`,
			"qqqq": `Where did the voice go?`,
			"uvwx-1": `She heard a clattering behind her.`,
			"uvwx-2": `It sounded like bones.`,
			"uvwx-3": `Maybe it was sticks or rocks, it couldn't be bones.`,
			"uvwx-4": `It shouldn't have been bones.`,
			"uvwx-5": `But rotting bodies had bones.`,
			"uvww-1": `"Are you scared?"`,
			"uvww-2": `What a sweet, cajoling voice, a dream trying to lull her back to sleep.`,
			"uvww-3": `Couldn’t they shut up!`,
			"uvww-4": `They were closer now, practically behind her.`,
			"uvww-5": `"I'm sorry I'm scaring you."`,
			"uvvv": `"YOU don't scare me."`,
			"uuuu": `"But you're scared."`,
			"vvvv": `"You! Don't scare me!"`,
			"wwww-1": `"Then how about THIS."`,
			"wwww-2": `A massive claw grabbed her head and pulled her into the dark.`
		}
	}
}
